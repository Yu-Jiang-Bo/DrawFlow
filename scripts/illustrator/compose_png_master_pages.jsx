...
(function () {
    ...
    function applyOutputTransforms(doc, policy) {
        ...
        var outlines = outlineCurrentTextFrames(doc, "V2 PNG master");
        if (policy.pathfinder_merge === true) mergeOverlappingTextOutlines(outlines, "V2 PNG master");
    }
    ...
    function pageItemBounds(item) {
        ...
        if (!bounds || bounds.length < 4) throw new Error("V2 PNG master text outline bounds are not measurable");
