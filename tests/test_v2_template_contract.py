...
@pytest.mark.parametrize("legacy", [None, {"enabled": False}])
def test_keeps_legacy_disabled_or_missing_render_mode_unset(legacy):
    payload = base_contract()
    if legacy is not None:
        payload["multi_name_customization"] = legacy
